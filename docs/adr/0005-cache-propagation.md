...
Use this decision when setting Compactor cache values or communicating the effect of a redirect mutation. It prevents Beacon from promising immediate redirect-runtime propagation it cannot provide.
