...
Use this decision when changing search, resolution lookup, activity history, reporting, or SQLite storage. It explains why Beacon has a local index without making it a second authoritative database.
